...
export function middleware(req: NextRequest) {
  ...
  console.log(`Next Request : ${req.headers.get("user-agent")}`)
  const cspHeader = `
    default-src 'self';
    script-src 'self' 'nonce-${nonce}' https://*.googletagmanager.com https://*.google-analytics.com https://connect.facebook.net https://*.googleapis.com https://cdnjs.cloudflare.com https://*.googleapis.com https://*.google.com https://*.gstatic.com;
    style-src 'self' 'nonce-${nonce}' https://*.googleapis.com https://cdnjs.cloudflare.com;
    img-src 'self' data: https://*.google-analytics.com https://*.googletagmanager.com https://*.google.com https://*.gstatic.com https://lh3.googleusercontent.com https://*.googleapis.com;  // Added *.googleapis.com here
