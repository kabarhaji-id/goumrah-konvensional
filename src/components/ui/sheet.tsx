  ...
  "fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 h-full w-full max-w-screen-sm border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
        right:
          "inset-0 m-auto h-full max-w-screen-sm w-full border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ withCloseButton, side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    z
    <SheetOverlay />
